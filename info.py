...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8003120158').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', "-1002505094282")
